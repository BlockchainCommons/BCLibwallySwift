...
class HDKeyTests: XCTestCase {
    ...
    func testBase58ToHDKey() throws {
        ...
        XCTAssertThrowsError(try ProtoHDKey(base58: "invalid"))
    }
    ...
    func testTpub() throws {
        ...
        let hdKey = try ProtoHDKey(base58: tpriv)
    ...
    func testParseTpub() throws {
        let tpub = "tpubDDgEAMpHn8tX5Bs19WWJLZBeFzbpE7BYuP3Qo71abZnQ7FmN3idRPg4oPWt2Q6Uf9huGv7AGMTu8M2BaCxAdThQArjLWLDLpxVX2gYfh2YJ"
        let hdKey = try ProtoHDKey(base58: tpub)
    ...
    func testOriginFingerPrint() throws {
        ...
        let tpub = "tpubDDgEAMpHn8tX5Bs19WWJLZBeFzbpE7BYuP3Qo71abZnQ7FmN3idRPg4oPWt2Q6Uf9huGv7AGMTu8M2BaCxAdThQArjLWLDLpxVX2gYfh2YJ"
        let key = try ProtoHDKey(base58: tpub, parent: DerivationPath(origin: .fingerprint(0xb4e3f5ed)))
    ...
    func testDeriveWithAbsolutePath() throws {
        ...
        let expectedChildKey = try ProtoHDKey(parent: hdKey, derivedKeyType: .public, childDerivationPath: relativePath)
        
        // This should ignore the first 4 levels
        let absolutePath = DerivationPath(string: "m/48h/0h/0h/2h/0/0")!
        let childKey = try ProtoHDKey(parent: hdKey, derivedKeyType: .public, childDerivationPath: absolutePath)
