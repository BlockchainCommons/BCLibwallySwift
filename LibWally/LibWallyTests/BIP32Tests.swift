...
//        XCTAssertEqual(path.steps, [.init(0, isHardened: true), .init(0)])
//        XCTAssertEqual(path†, "m/0'/0") // description always uses h instead of '
//    }
//    
...
//        XCTAssertNil(ChildIndex(UINT32_MAX))
//    }
//    
...
//
//        XCTAssertNotNil(childKey.base58PrivateKey)
...
//        let childKey = hdKey.derive(path: path)!
//        
//        XCTAssertNotNil(childKey.base58PublicKey)
