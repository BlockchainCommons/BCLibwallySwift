...
class BIP32Tests: XCTestCase {
    let seed = try! BIP39Seed(hex: "c55257c360c07c72029aebc1b53c05ed0362ada38ead3e3e9efa3708e53495531f09a6987599d18264c1e1c92f2cf141630c7a3c4ab7c81b2f001698e7463b04")
    ...
    func testBase58ToHDKey() throws {
        ...
        let hdKey = try HDKey(xpriv)
        XCTAssertEqual(hdKey.description, xpriv)
        
        XCTAssertThrowsError(try HDKey("invalid"))
    }
    ...
    func testMasterKeyFingerPint() throws {
        ...
        let tpub = "tpubDDgEAMpHn8tX5Bs19WWJLZBeFzbpE7BYuP3Qo71abZnQ7FmN3idRPg4oPWt2Q6Uf9huGv7AGMTu8M2BaCxAdThQArjLWLDLpxVX2gYfh2YJ"
        let key = try HDKey(tpub, masterKeyFingerprint:Data(hex: "b4e3f5ed"))
    ...
    func testAbsolutePathFromString() throws {
        let path = try BIP32Path("m/0'/0") // 0' and 0h are treated the same
        XCTAssertEqual(path.components, [.hardened(0), .normal(0)])
    ...
    func testDeriveFromXpub() throws {
        ...
        let hardenedPath = try BIP32Path("m/0'")
