...
class PSBTTests: XCTestCase {
    ...
    // Public keys
    let pubKey0 = ECCompressedPublicKey(hex: "029583bf39ae0a609747ad199addd634fa6108559d6c5cd39b4c2183f1ab96e07f")!
    let pubKey1 = ECCompressedPublicKey(hex: "02dab61ff49a14db6a7d02b0cd1fbb78fc4b18312b5b4e54dae4dba2fbfef536d7")!
    let pubKey2 = ECCompressedPublicKey(hex: "03089dc10c7ac6db54f91329af617333db388cead0c231f723379d1b99030b02dc")!
    let pubKey3 = ECCompressedPublicKey(hex: "023add904f3d6dcf59ddb906b0dee23529b7ffb9ed50e5e86151926860221f0e73")!
    let pubKey4 = ECCompressedPublicKey(hex: "03a9a4c37f5996d3aa25dbac6b570af0650394492942460b354753ed9eeca58771")!
    let pubKey5 = ECCompressedPublicKey(hex: "027f6399757d2eff55a136ad02c684b1838b6556e5f1b6b34282a94b6b50051096")!
    ...
    func testPSBTAddress() {
        let psbt = PSBT(base64: "")!
        print(psbt.outputs.first!.address(network: .testnet))
    }
}
