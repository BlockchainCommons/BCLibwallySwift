...
class PSBTTests: XCTestCase {
    ...
    func testSignRealMultisigWithHDKey() {
        ...
        XCTAssertEqual(psbtWithoutChangedFinalized.finalizedTransaction()!.description, multiPSBTWithoutChangeHex)
        ...
        XCTAssertEqual(psbtWithChangedFinalized.finalizedTransaction()!.description, multiPSBTWithChangeHex)
